                                                                ...
                                                                .then(argument("blockType",
                                                                                ...
                                                                                .executes(context -> {
                                                                                        BlockPos pos = BlockPosArgumentType
                                                                                                        .getBlockPos(context,
                                                                                                                        "blockPosition");
                                                                                        BlockStateArgument blockType = BlockStateArgumentType
                                                                                                        .getBlockState(context,
                                                                                                                        "blockType");
                                                                                        settings.addResourcePosition(
                                                                                                        pos,
                                                                                                        blockType.getBlockState()
                                                                                                                        .getBlock()
                                                                                                                        .asItem());
                                                                                        context.getSource()
                                                                                                        .sendFeedback(() -> Text
                                                                                                                        .literal("Settings location"),
                                                                                                                        false);
